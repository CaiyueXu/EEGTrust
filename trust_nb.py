...
if __name__ == '__main__':
    ...
    os.makedirs("./tmp_out/trust_nb/sub12", exist_ok=True)

    logger = logging.getLogger('nb_sub12')
    logger.setLevel(logging.DEBUG)
    console_handler = logging.StreamHandler()
    file_handler = logging.FileHandler('./tmp_out/trust_nb/sub12/nb_sub12.log')
    ...
    dataset = NumpyDataset(X=X,
                        y=y,
                        io_path=f'./tmp_out/trust_nb/sub12/deta',
    ...
    # label (int)
    k_fold = KFold(n_splits=10, split_path=f'./tmp_out/trust_nb/sub12/split', shuffle=True)
